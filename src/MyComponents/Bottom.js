  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center gap-5">
        ...
        <img src={Frame7} alt="Frame7" className="mt-[45px] max-md:w-[95%]" />
        <p className="hopes font-normal mt-5 mb-[45px] sm:mb-[56px] text-[24px] sm:text-[32px] max-md:w-[88%]  text-center">
      ...
      <div className=" w-[90%] sm:w-[80%] flex flex-row max-lg:flex-col mx-auto justify-end items-center  mt-[170px] sm:mt-[252px] mb-[150px] sm:mb-[227px]   relative rounded-lg  bg-[#7D75D8] ">
        ...
        <div className=" w-[90%]  md:w-[80%] lg:w-[40%]  flex flex-col mt-[70%] md:mt-[65%] lg:mt-[1%] pt-[20px]   xl:pt-[88px] pb-[40px] xl:pb-[95px] lg:mr-[2%] xl:mr-[80px]">
          <h1 className="publish max-sm: w-[80%] text-[40px] sm:text-5xl text-white sm:mb-5   " >
            Publish a book NFT
          </h1>
          <p className="text-white text-[20px] sm:text-2xl font-[400px] mb-3 sm:mb-5">
      ...
      <div className=" h-auto mb-10  pb-5 bg-[#F1F0F9] mt-[50px] w-[100%] mx-auto relative ">
        ...
        <div className=" sm:max-w-full  md:flex flex-wrap  mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-around items-center max-md:mx-5 mx-auto gap-[42px] mt-[42px] mb-20 sm:mb-24">
            <div className="max-sm:w-[308px] ">
