    ...
    return (
        <div className='flex-col-reverse w-[95%]  sm:w-[90%] mx-auto flex md:flex-row justify-between ' >
            <div className='flex flex-col'>
                <h1 className='Prata font-normal text-[40px] sm:text-[60px] md:text-8xl w-[280px] sm:w-[500px] text-white ml-5 sm:ml-12 mt-6 sm:mt-28'>Your books  on <span className='max-sm:hidden '>-</span> chain </h1>
            ...
            <div className='w-[100%] h-[417px] md:w-[50%]   flex justify-center items-center text-center'>




                <img src={Image2} alt="Image2" className='w-[335px]' />
            </div>
